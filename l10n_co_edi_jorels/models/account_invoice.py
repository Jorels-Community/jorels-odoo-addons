            ...
            if type_edi_document != 'none':
                ...
                if rec.get_type_edi_document() == 'invoice':
                    json_request['resolution'] = {
                        ...
                        'resolution_date': rec.resolution_id.resolution_resolution_date,
                        ...
                        'date_from': rec.resolution_id.resolution_date_from,
                        'date_to': rec.resolution_id.resolution_date_to
                    }
                else:
