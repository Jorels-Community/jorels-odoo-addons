            ...
            for res_id, template in self.get_email_template(res_ids).items():
                ...
                if template.id in (ei_template.id, inv_default_template.id):
                    ...
                    if invoice.is_to_send_edi_email():
                        ...
                        # Update invoice with new zip content
                        invoice.write({
