...
class AccountMove(models.Model):
    ...
    tax_totals_company_json = fields.Char(
        string="Invoice Totals in company currency JSON",
    ...
    @api.depends('line_ids.amount_currency', 'line_ids.tax_base_amount', 'line_ids.tax_line_id', 'partner_id', 'company_currency_id', 'amount_total_signed', 'amount_untaxed_signed')
    def _compute_tax_totals_company_json(self):
        ...
        for move in self:
            ...
            move.tax_totals_company_json = json.dumps({
                **self._get_tax_totals(move.partner_id, tax_lines_data, move.amount_total_signed, move.amount_untaxed_signed, move.company_currency_id),
