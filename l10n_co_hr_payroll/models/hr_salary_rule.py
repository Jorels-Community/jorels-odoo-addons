...
class HrSalaryRule(models.Model):
    ...
    earn_category = fields.Selection([
        ...
        ('daily_overtime', 'Daytime overtime hours'),
        ('overtime_night_hours', 'Night overtime hours'),
        ('hours_night_surcharge', 'Night surcharge'),
        ('sunday_holiday_daily_overtime', 'Sunday and holiday daytime overtime hours'),
        ('daily_surcharge_hours_sundays_holidays', 'Sunday and holiday daytime surcharge'),
        ('sunday_night_overtime_holidays', 'Sunday and holiday night overtime hours'),
        ('sunday_holidays_night_surcharge_hours', 'Sunday and holiday night surcharge'),
