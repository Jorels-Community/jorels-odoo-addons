...
class PosOrder(models.Model):
    ...
    def get_invoice(self):
        ...
        return {
            ...
            "resolution_resolution": self.account_move.journal_id.resolution_invoice_id.resolution_resolution,
            "resolution_resolution_date": self.account_move.journal_id.resolution_invoice_id.resolution_resolution_date,
            "resolution_prefix": self.account_move.journal_id.resolution_invoice_id.resolution_prefix,
            "resolution_from": self.account_move.journal_id.resolution_invoice_id.resolution_from,
            "resolution_to": self.account_move.journal_id.resolution_invoice_id.resolution_to,
            "resolution_date_from": self.account_move.journal_id.resolution_invoice_id.resolution_date_from,
            "resolution_date_to": self.account_move.journal_id.resolution_invoice_id.resolution_date_to,
        }
